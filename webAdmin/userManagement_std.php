		  ...
		  <div class="col-sm-12">
				<div class="card"  style="width: 100%;">
					<div class="card-body">
	  				...
	  				<li class="nav-item">
	    				<a class="nav-link active" style="color: #56187F;" href="userManagement_std.php"><i class="fas fa-user-graduate"></i> นักศึกษา</a>
	  				</li>
	  				<li class="nav-item">
	    				...
	    				<a class="nav-link" style="color: #56187F;" href="userManagement_admin.php"><i class="fas fa-user-shield"></i> ผู้ดูแลระบบ</a>
								...
								<div class="table-responsive-sm">
									<table class="table table-hover" id="example2">
										...
										<tbody>
										<?php include('../api/userManagement/userTable_std.php'); ?>
										</tbody>
									</table>
								</div>
					</div>
