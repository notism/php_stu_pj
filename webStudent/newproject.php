...
if(move_uploaded_file($_FILES["Picture"]["tmp_name"],"../img/".$_FILES["Picture"]["name"])){
    ...
    $sql = "INSERT into projectinfo (ProjectName , Type , Description , Advisor , P1 , P2 , P3 , P4 , P5 , Picture , File , Status , CreatedBy , fu , de)
    VALUES ('".$Pname."', '".$Ptype."', '".$PDes."' , '".$Aname."' , '".$P1."' , '".$P2."' ,'".$P3."' , '".$P4."' , '".$P5."' , '".$Pic."' , '".$Doc."' , 'รออนุมัติ' , '".$D."' , '".$fu."' , '".$dep."')";
