...
if($_FILES["Picture"]["name"]!="" || $_FILES["Pdf"]["name"]!=""){
 if((($type==".jpg")||($type==".gif")||($type==".png"))&&($type2==".pdf")){
    ...
    if(move_uploaded_file($_FILES["Picture"]["tmp_name"],"../img/".$_FILES["Picture"]["name"])){
        ...
        SET ProjectName = '".$Pname."', Type = '".$Ptype."', Description = '".$Des."' , Advisor = '".$Aname."' , P1 = '".$P1."' , P2 = '".$P2."'  , P3 = '".$P3."' , P4 = '".$P4."' , P5 = '".$P5."' , Picture = '".$Pic."' , File = '".$Doc."' , Status = '".$Sta."' , CreatedBy = '".$D."' , fu = '".$fu."' , de = '".$dep." '
        WHERE Id = '".$PId."'";
                ...
                if ($db->query($sql) === TRUE) {
                   ...
                   <p class='mb-0'>สามารถสอบถามการใช้งาน หรือแจ้งปัญหาการใช้งานได้ ไปยังเมนูผู้ดูแลระบบ.</p>
                    ...
                    อัพโหลดโครงงานไม่ได้<a href='#' class='alert-link'> เกิดข้อผิดพลาด</a>. อัพเดตโครงงานใหม่อีกครั้งภายหลัง หรือแจ้งปัญหาไปยังเมนูผู้ดูแลระบบ.
                    </div>
                    ";
                }
    ...
    include('../config/connect.php');
        $sql = "UPDATE projectinfo
        SET ProjectName = '".$Pname."', Type = '".$Ptype."', Description = '".$Des."' , Advisor = '".$Aname."' , P1 = '".$P1."' , P2 = '".$P2."'  , P3 = '".$P3."' , P4 = '".$P4."' , P5 = '".$P5."' , Status = '".$Sta."'   , CreatedBy = '".$D."' , fu = '".$fu."' , de = '".$dep." '
        WHERE Id = '".$PId."'";
