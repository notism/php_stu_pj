        ...
        <CENTER><button type='button' class='btn purple-gradient btn-lg' data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-plus"></i> อัพโหลดโครงงาน</button><br></CENTER>
            ...
            <Table width="97%" ><tr><td>
						...
						<ul class="pagination pg-blue">
							<li class="page-item ">
							<a href="project.php" class="page-link">ทั้งหมด</a>
							</li>
  ...
  <?php
            ...
            $i = 1;
						...
						if ($result->num_rows > 0) {
							...
							<td width=10% align='center'><button type='button' class='btn btn-danger btn-rounded btn-sm my-0' ><i class='fas fa-edit '></i> แก้ไข</button></td>
							</tr>
							</Table></li>
						    </ul>  
						      ";$i++;
