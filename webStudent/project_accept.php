...
if(name == "1"){
document.getElementById("note").innerHTML="<select name='P1name'><option value='' disabled selected>คนที่ 1 </option><?php
...
?></select><select name='P2name'><option value='' disabled selected>คนที่ 2 </option><?php
...
?></select><select name='P3name'><option value='' disabled selected>คนที่ 3 </option><?php
...
?></select><select name='P4name'><option value='' disabled selected>คนที่ 4 </option><?php
...
?></select><select name='P5name'><option value='' disabled selected>คนที่ 5 </option><?php
...
<main>
        ...
        <CENTER><button type='button' class='btn purple-gradient btn-lg' data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-plus"></i> อัพโหลดโครงงาน</button><br></CENTER>
            ...
            <Table width="97%" ><tr><td>
						...
						<ul class="pagination pg-blue">
							<li class="page-item ">
							<a href="project_all.php" class="page-link">ทั้งหมด</a>
							</li>
							<li class="page-item active"><a class="page-link">อนุมัติแล้ว</a></li>
  ...
  <?php
		      	...
		      	$sql = "SELECT * FROM projectinfo where ( P1 = $D or P2 = $D or P3 = $D or P4 = $D or P5 = $D ) and status = 'อนุมัติแล้ว'";
						$result = $db->query($sql);
            $i = 1;
...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    ...
    <tr><td  width=15% align="center"><font color="#540eff"><i class="fas fa-university fa-2x "></i></font></td>
    <td>
          <select id="mySelect" onchange="myFunctionFac()" name="fu" required>
    ...
    <tr><td width=15% align="center"><font color="#7502f3"><i class="fas fa-graduation-cap fa-2x "></i></font>
    <td id="demo">

    <select id="mySelect2"  name="de" required>
