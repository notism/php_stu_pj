...
<main>
        ...
        <CENTER><button type='button' class='btn purple-gradient btn-lg' data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-plus"></i> อัพโหลดโครงงาน</button><br></CENTER>
            ...
            <Table width="97%" ><tr><td>
						...
						<ul class="pagination pg-blue">
							...
							<li class="page-item active"><a  class="page-link">รออนุมัติ</a></li>
  ...
  <?php
						...
						$sql = "SELECT * FROM projectinfo where (P1 = $D or P2 = $D or P3 = $D or P4 = $D or P5 = $D) and status = 'รออนุมัติ'";
						$result = $db->query($sql);
            $i = 1;
...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    ...
    <select id="mySelect2"  name="dep" required>
